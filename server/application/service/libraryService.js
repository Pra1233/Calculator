...
var libraryModel = new libraryModel_js_1.default();
var LibraryService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, libraryModel.findAll()];
                    case 1:
                        books = _a.sent();
    ...
    LibraryService.prototype.createBook = function (book) {
        return __awaiter(this, void 0, void 0, function () {
            var error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, libraryModel.create(book)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, libraryModel.delete(id)];
                    case 1:
                        book = _a.sent();
    ...
    LibraryService.prototype.updateBook = function (id, book) {
        return __awaiter(this, void 0, void 0, function () {
            var newBook;
            return __generator(this, function (_a) {
                try {
                    ...
                    newBook = libraryModel.update(id, book);
