...
var container_1 = require("../../library/dependencyInjection/container");
var library = container_1.default.resolve("libraryService"); //key
var getBooks = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, library.getAllBooks()];
            case 1:
                books = _a.sent();
                res.status(200).json({
                    success: true,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                book = req.body;
                return [4 /*yield*/, library.createBook(book)];
            case 1:
                newbook = _a.sent();
                res.status(200).json({
                    success: true,
...
var deleteBook = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, library.deleteBook(Number(id))];
            case 2:
                _a.sent();
                res.status(200).json({
                    success: true,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                id = req.params.id;
                book = req.body;
                return [4 /*yield*/, library.updateBook(Number(id), book)];
            case 1:
                _a.sent();
                res.status(200).json({
                    success: true,
